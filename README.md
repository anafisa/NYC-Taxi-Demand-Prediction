...
The goal of this project is to build a model that predicts trip amount of yellow taxi in every district of NYC. 
...
While building a model we should remember that the time series have complex seasonability 24 and 168 lags, so we need extra features to model seasonality correctly. In this case we may use fourier series or dummy variables.
